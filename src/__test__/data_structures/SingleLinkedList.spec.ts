...
class SLinkedListUtil {
  static prependNewList<T>(arr: T[]): SingleLinkedList<unknown> {
    // Arrange
  ...
  static printList<T>(ll: SingleLinkedList<T>) {
    const values = [];
...
describe("Single Linked List", [
  ...
  test("get() should return value from provided index", () => {
    ...
    const linkedList = SLinkedListUtil.prependNewList(values);
